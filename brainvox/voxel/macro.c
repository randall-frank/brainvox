...
static int Return_Strings = 0;

long int init_parser(char *exp,long int tokenize, long int use_strings)
{
	Return_Strings = 0;
        if (use_strings) Return_Strings = 1;
