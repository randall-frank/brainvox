...
#ifdef CAP_NOUS
#define bv_nifti_io_ BV_NIFTI_IO
#define bv_nifti_cleanup_ BV_NIFTI_CLEANUP
#define bv_xflip_ BV_XFLIP
#define bv_yflip_ BV_YFLIP
#endif

int bv_nifti_hdrcheck(nifti_1_header *hdr, int *iSingle, int *iOff);
int bv_nifti_io_(char *file,int *iwrite, void *data,int *dx,int *dy,
