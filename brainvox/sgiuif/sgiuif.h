...
*
*	Define attribute masks
*
	Integer*4	DLG_M_JUSTIFY
	Parameter	(DLG_M_JUSTIFY = 12)
	Integer*4	DLG_J_CENT
	Parameter	(DLG_J_CENT = 0)
	Integer*4	DLG_J_LEFT
	Parameter	(DLG_J_LEFT = 4)
	Integer*4	DLG_J_RIGHT
	Parameter	(DLG_J_RIGHT = 8)
	Integer*4	DLG_M_GRAY
	Parameter	(DLG_M_GRAY = 16)
	Integer*4	DLG_M_FRAME
	Parameter	(DLG_M_FRAME = 2)
	Integer*4	DLG_M_INVERT
	Parameter	(DLG_M_INVERT = 1)
	Integer*4	DLG_M_FONT
	Parameter	(DLG_M_FONT = 256*255)
*
