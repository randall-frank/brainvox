...
button .image.r.file.buttons.add -text "Add..." -command {
	if [winfo exists .select_reslice_file] {
		...
		GetFileName .select_reslice_file .air extended
...
radiobutton .output.config.modality.buttons.wsincscan -variable modality -text "3D windowed scanline sinc" -value 6 -background $color4 -highlightthickness 0 -command Wsincscan
radiobutton .output.config.modality.buttons.sincscan -variable modality -text "3D unwindowed scanline sinc (slow)" -value 7 -background $color4 -highlightthickness 0 -command Sincscan
radiobutton .output.config.modality.buttons.chirpscan -variable modality -text "3D scanline chirp-z" -value 10 -background $color4 -highlightthickness 0 -command Chirpscan
radiobutton .output.config.modality.buttons.chirpxy -variable modality -text "Scanline chirp-z xy/Linear z" -value 11 -background $color4 -highlightthickness 0 -command Chirpxy


pack .output.config.modality.buttons.nearest  .output.config.modality.buttons.trilinear .output.config.modality.buttons.sincxy .output.config.modality.buttons.sincxz .output.config.modality.buttons.sincyz .output.config.modality.buttons.sinc .output.config.modality.buttons.wsincscan .output.config.modality.buttons.sincscan .output.config.modality.buttons.chirpscan .output.config.modality.buttons.chirpxy -side top -anchor w -fill y
