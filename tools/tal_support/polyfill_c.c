...
C
C	07 Mar 98	rjf
C			Converted from use of (int) to (long int).
C
C	13 Jul 95	rjf
 ...
 * $Id: polyfill_c.c 1599 2006-01-22 03:45:10Z rjfrank $
 *
 */
...
/* local prototypes */
long int	mnext_y(long int *trace, long int count, long int item);
void	sort_on_bigger_y(long int n,long int *trace,each_entry *sides,
		long int *side_count, long int *bottomscan);
void	put_in_sides_list(each_entry *sides,long int ientry,long int ix1,
		long int iy1, long int ix2,long int iy2,long int next_y);
void	update_first_last(each_entry *sides,long int count,long int scan,
		long int *first_s,long int *last_s);
void	process_x_intersections(each_entry *sides,long int scan,
		long int first_s,long int last_s, long int *x_int_count);
void 	sort_on_x(long int ientry,long int first_s,each_entry *sides);
void	draw_lines(each_entry *sides,long int scan,long int x_int_count,
		long int iindex,long int *list,long int *ptr,long int max_list);
void	update_sides_list(each_entry *sides,long int first_s,long int last_s);

void	polyfill_c_(long int *trace,long int count,long int *list,long int *ptr)
{
/*
...
*/
	...
	long int	side_count,first_s,last_s;
	long int	scan,bottomscan,x_int_count;
/*
...
long int	mnext_y(long int *trace,long int n,long int k)
{
	long int	j,out;
